...
for file1 in $files; do
    ...
    if [ -e "$file2" ]; then
        ...
        bsub -g /andrew.martin/trim_decon_compute1 -n 16 -R 'rusage[mem=32GB]' -q general -a 'docker(biobakery/kneaddata)' kneaddata --input $file1 --input $file2 -db storage1/fs1/rnewberry/Active/Andrew_metagenome_seq/KneadDataDecon/mouse_C57BL_6NJ --sequencer-source TruSeq3 --output scratch1/fs1/rnewberry/Andrew/trim_decon_output/${base_name}/
